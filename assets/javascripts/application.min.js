...
var app;$(document).ready(function(){return app.init()}),app={init:function(){return this.bind_events()},bind_events:function(){return $(window).scroll(function(e){return function(){return e.header_parallax()}}(this)),$(document).on("click",".btn-more",function(e){return $("html,body").animate({scrollTop:$(".header-wrapper").height()+"px"},1e3)}),$(document).on("change",".file-upload",this.process_file)},process_file:function(e){var n,o;return n=this.files[0],o=new FileReader,o.addEventListener("load",function(e){var n;return n=e.target,app.image2shadow(n.result)}),o.readAsDataURL(n)},image2shadow:function(e){var n;return n=new Image,n.crossOrigin="Anonymous",n.src=e,n.onload=function(){var e,o,t,r,a,i,s,c,d,h,u,p,g,l,w,m;for($(".code, .image-preview, .preview, .preview-shadow, .avg-color").show(),t=document.querySelector(".image-preview"),a=t.getContext("2d"),h=n.width,d=n.height,t.setAttribute("width",h),t.setAttribute("height",d),a.drawImage(n,0,0),u=a.getImageData(0,0,h,d),p=u.data,r="",o="",w=0,m=0,l=0,i=0,e=0,c=0;c<p.length;)g=Math.round(100/p.length*c),console.log("Progress: "+g+"%"),l+=p[c],i+=p[c+1],e+=p[c+2],s=app.rgbToHex(p[c],p[c+1],p[c+2]),c>0&&(r+=w+"px "+m+"px "+s+", "),0===c&&(o=s,$(".preview-shadow").css("background-color",s)),h-1>w?w++:(w=0,m++),c+=4;return r=r.substring(0,r.length-2),$(".preview-shadow").css("box-shadow",r),$(".preview-shadow").css("margin-bottom",d+20+"px"),r="width: 1px;\nheight: 1px;\nbackground-color: "+o+";\nbox-shadow: "+r+";",$(".code").html(r),l=Math.round(l/p.length/4),i=Math.round(i/p.length/4),e=Math.round(e/p.length/4),$(".avg-color span").css("background-color",app.rgbToHex(l,i,e))}},componentToHex:function(e){var n;return n=e.toString(16),1===n.length?"0"+n:n},rgbToHex:function(e,n,o){return"#"+this.componentToHex(e)+this.componentToHex(n)+this.componentToHex(o)},header_parallax:function(){var e;return $(window).width()>600?(e=$(window).scrollTop()/5*-1,$(".header-wrapper").css("background-position","50% "+e+"px")):void 0}};